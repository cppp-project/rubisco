...
"""Rubisco binary package builder."""
...
from rubp_build.config import EXTENSION_NAME, LOCALE_DIR_NAME
from rubp_build.events import mount_to_cefs
from rubp_build.steps import RUBPPackStep

__all__ = ["instance"]


class RuBPBuildExtension(IRUExtension):
    """Rubisco binary package builder."""

    ktrigger = IKernelTrigger()
    workflow_steps: ClassVar[dict[str, type[Step]]] = {
        "rubp-pack": RUBPPackStep,
    }
